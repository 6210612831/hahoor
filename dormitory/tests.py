...
# Dormitories_view
    ...
    def test_dormitory_view_without_auth(self):
        c = Client()
...
# My_review view
    ...
    def test_my_review_view_without_authen(self):
        c = Client()
        responses = c.get(
            reverse('dormitory:my_review'))
        self.assertEqual(responses.status_code, 302)

    def test_my_review_view(self):
        c = Client()
        user = User.objects.get(username='user1', email='user1@exp.com')
        c.force_login(user)
        responses = c.get(
...
# Update_dormitory review

    def test_update_dormitory_not_my_dorm(self):
        c = Client()
        user = User.objects.get(username='user2')
        c.force_login(user)
        responses = c.get(
            reverse('dormitory:update_dormitory', args=(1,)))
        self.assertEqual(responses.status_code, 302)

    def test_update_dormitory_with_post(self):
        c = Client()
    ...
    def test_update_dormitory_without_post(self):
        c = Client()
        user = User.objects.get(username='user1')
        c.force_login(user)
        responses = c.get(
...
# Update_review view
    ...
    def test_update_review_without_auth(self):
        c = Client()
        responses = c.get(
            reverse('dormitory:update_review', args=(1,)))
        self.assertEqual(responses.status_code, 302)

    def test_update_review_not_my_review(self):
        c = Client()
        user = User.objects.get(username='user2')
        c.force_login(user)
        responses = c.get(
    ...
    def test_update_review_with_post(self):
        c = Client()
        user = User.objects.get(username='user1')
        c.force_login(user)
        responses = c.post(
    ...
    def test_update_review_without_post(self):
        c = Client()
        user = User.objects.get(username='user1')
        c.force_login(user)
        responses = c.get(
...
# Delete_review view
    ...
    def test_delete_review_without_auth(self):
        c = Client()
        responses = c.get(
            reverse('dormitory:delete_review', args=(1,)))
        self.assertEqual(responses.status_code, 302)

    def test_delete_review_not_my_review(self):
        c = Client()
        user = User.objects.get(username='user2')
        c.force_login(user)
        responses = c.get(
...
# Delete_dormitory view

    def test_delete_dormitory_without_auth(self):
        c = Client()
        responses = c.get(
            reverse('dormitory:delete_dormitory', args=(1,)))
        self.assertEqual(responses.status_code, 302)

    def test_delete_dormitory_not_my_review(self):
        c = Client()
        user = User.objects.get(username='user2')
        c.force_login(user)
        responses = c.get(
    ...
    def test_delete_dormitory_view(self):
        c = Client()
        user = User.objects.get(username='user1')
        c.force_login(user)
        responses = c.get(
...
# reset_report_review view

    def test_reset_report_review_without_auth(self):
        c = Client()
        responses = c.get(
            reverse('dormitory:reset_report_review', args=(1,)))
        self.assertEqual(responses.status_code, 302)

    def test_reset_report_review_not_my_review(self):
        c = Client()
        user = User.objects.get(username='user2')
        c.force_login(user)
        responses = c.get(
