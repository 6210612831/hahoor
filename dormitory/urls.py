...
urlpatterns = [
                ...
                path("dormitory/review/<int:dormitory_id>", views.review_dormitory,name = "review_dormitory"),
                path("dormitory/report_review/<str:dormitory_title>/<int:review_id>", views.report_review,name = "report_review"),
]
